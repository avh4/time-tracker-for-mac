//
//  TTDocumentController.h
//  Time Tracker
//
//  The TTDocumentController is responsible for loading the correct version of the data model
...
@interface TTDocumentController : NSObject {
